...
<html>
	...
	<spring:url value="/initComGm003" var="actionUrl"/>
		...
		<div>
			...
			<label>生年月日：<form:input path="seinengappiFrom"/>～<form:input class="Birth_I" path="seinengappiTo"/></label>
			<label class="hidarizoroe">前職：<form:input path="previous"/></label>
			<label>役職：<select name="psition"></select></label>
			<label>入社日：<form:input path="nyusyabiFrom"/>～<form:input path="nyusyabiTo"/></label>
			...
			<label>住所：<form:input id="Address" path="address"/></label>
